"""
Django settings for throbbing_moon_40675 project.
...
ROOT_URLCONF = 'throbbing_moon_40675.urls'
...
WSGI_APPLICATION = 'throbbing_moon_40675.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "throbbing_moon_40675 API",
    "DESCRIPTION": "API documentation for throbbing_moon_40675 App",
    "VERSION": "v1",
}
